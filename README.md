...
Самый простой способ установить фреймворк (в unix-подобных ОС):
...
```
$ python3 examples/GKLS_example.py
$ python3 examples/Rastrigin_example.py
```
...
Для построения документации необходимо предварительно установить пакет **sphinx** (лучше с правами администратора). После этого перейти в каталог **docs**, находящийся в корневой папке и дать команду
