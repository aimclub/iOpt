...
class StaticPainterListener(Listener):
    ...
    def __init__(self, file_name: str, path_for_saves="", indx=0, is_points_at_bottom=False, mode='objective function'):
        ...
        :param mode: The calculation method for drawing the graph of the target function that will be used. Possible
           ...
           neuroapproximation for the target function based on the obtained search information.
           The 'interpolation' mode builds interpolation for the target function based on the obtained search information.
           The 'only points' mode does not plot the target function.
        """
        self.file_name = file_name
        self.path_for_saves = path_for_saves
...
class StaticPainterNDListener(Listener):
    ...
    def __init__(self, file_name: str, path_for_saves="", vars_indxs=[0, 1], mode='lines layers',
        ...
        :param mode_: Drawing mode of the target function graph that will be used.
        ...
        :param calc: The calculation method for drawing the graph of the target function that will be used. Possible
           modes: 'objective function' (only in the 'line layers' mode), 'approximation' (only in the 'surface' mode)
           and 'interpolation'. The 'objective function' mode builds a graph by calculating the values of the target function on a uniform grid.
           grid. The 'approximation' mode builds a neuroapproximation for the target function based on the obtained search information.
           information. The 'interpolation' mode builds interpolation for the target function based on the obtained search information.
           information.
        """
        self.file_name = file_name
        self.path_for_saves = path_for_saves
