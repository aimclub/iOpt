...
class GKLSRandomGenerator:
    ...
    def Initialize(self, seed, 
        ...
        while (t > 0):
            ...
            for j in range(GKLSRandomGenerator.KK + GKLSRandomGenerator.KK - 2, GKLSRandomGenerator.KK - GKLSRandomGenerator.LL, -2):
            ...
            for j in range(GKLSRandomGenerator.KK + GKLSRandomGenerator.KK - 2, GKLSRandomGenerator.KK - 1, -1): 
               if (ul[j] != 0): 
                ul[j - (GKLSRandomGenerator.KK - GKLSRandomGenerator.LL)] = ulp - ul[j - (GKLSRandomGenerator.KK - GKLSRandomGenerator.LL)]
                u[j - (GKLSRandomGenerator.KK - GKLSRandomGenerator.LL)] = GKLSRandomGenerator.mod_sum(u[j - (GKLSRandomGenerator.KK - GKLSRandomGenerator.LL)], u[j])
            ...
            if (GKLSRandomGenerator.is_odd(s) != 0):                           # "multiply by z" */
                ...
                if (ul[GKLSRandomGenerator.KK]):
                    ...
                    u[GKLSRandomGenerator.LL] = GKLSRandomGenerator.mod_sum(u[GKLSRandomGenerator.LL], u[GKLSRandomGenerator.KK])
    ...
    def GenerateNextNumbers(self):
        ...
        for i in range(GKLSRandomGenerator.LL, GKLSRandomGenerator.KK): 
            self.ran_u[i] = GKLSRandomGenerator.mod_sum(self.rnd_num[j - GKLSRandomGenerator.KK], self.ran_u[i - GKLSRandomGenerator.LL])
            j = j + 1
